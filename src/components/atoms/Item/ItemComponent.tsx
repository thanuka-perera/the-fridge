  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0">
        <div className="">
          <span
            className={`inline-flex items-center justify-center px-3 py-1 rounded-full text-xs font-medium transition-colors duration-200 
                        ${status.labelClasses}`}
        ...
        <div
          className="flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-200 group-hover:bg-red-50 hover:bg-red-100 flex-shrink-0"
          onClick={(e) => {
            e.stopPropagation();
        ...
        >
          <Trash
            className="text-[#2E3849] cursor-pointer hover:text-red-500"
            size="16"
            onClick={onDelete}
          />
        </div>
